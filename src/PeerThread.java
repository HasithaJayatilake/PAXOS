    ...
    public void run() {
        try {
            ...
            while (runPeer) {
                ...
                if ((this.proposerPhase.equals(phase2)) && (this.acceptOkCount >= this.peer.quorum) && this.keepAlive) {
            ...
            switch (inputMessageType) {
                case "proposal":
                    ...
                    if (proposalNum > promiseNum) {
                        ...
                        outputmsg = this.memberName + ":" + outputMessageType + "-" + sender + "-"
                                + proposalNumberString + "-" + outputValue;
                        if (verbose) {
                            System.out
                                    .println(">> " + this.memberName + ": Sending prepare-ok of value: " + outputValue);
                        }
                ...
                case "acceptRequest":
                    if (this.faulty != 1) {
                        ...
                        if (proposalNum == promiseNum) {
                            if (verbose) {
                                System.out
                                        .println(">> " + this.memberName + ": Setting president to: " + incomingValue);
                            }
                            this.peer.president = incomingValue;
                            ...
                            if (verbose) {
                                System.out
                                        .println(">> " + this.memberName + ": Set Paxos leader to " + this.paxosLeader);
                            }
